...
document.addEventListener("DOMContentLoaded", () => {
  ...
  var sidebarToggleMotion = {
    ...
    init: function () {
      ...
      document
        .querySelector(".sidebar-toggle")
        .addEventListener("mouseenter", this.mouseEnterHandler.bind(this));
      document
        .querySelector(".sidebar-toggle")
    ...
    mouseupHandler: function (event) {
      ...
      var clickingBlankPart =
        Math.sqrt(deltaX * deltaX + deltaY * deltaY) < 20 &&
        event.target.matches(".main");
      if (
        this.isSidebarVisible &&
        (clickingBlankPart ||
          event.target.matches("img.medium-zoom-image, .fancybox img"))
      ) {
        this.hideSidebar();
      }
    },
    ...
    showSidebar: function () {
      ...
      if (typeof Velocity === "function") {
        Velocity(
          document.querySelectorAll(".sidebar .motion-element"),
